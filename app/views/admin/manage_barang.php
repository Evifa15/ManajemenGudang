...
<main class="app-content">
    ...
    <div class="content-header">
        ...
        <a href="<?php echo BASE_URL; ?>admin/addBarang" class="btn btn-primary">+ Tambah Barang Baru</a>
    </div>
        ...
        <nav>
            <ul class="pagination">
                <?php
                    ...
                    // (misal: ?search=evi&kategori=1)
                    $filterQuery = !empty($queryParams) ? '?' . http_build_query($queryParams) : '';
                ?>

                <?php if ($currentPage > 1) : ?>
                    <li class="page-item"><a class="page-link" href="<?php echo BASE_URL; ?>admin/barang/<?php echo $currentPage - 1; ?><?php echo $filterQuery; ?>">Previous</a></li>
                <?php else : ?>
                    <li class="page-item disabled"><a class="page-link" href="#">Previous</a></li>
                <?php endif; ?>
                <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
                    <li class="page-item <?php echo ($i == $currentPage) ? 'active' : ''; ?>"><a class="page-link" href="<?php echo BASE_URL; ?>admin/barang/<?php echo $i; ?><?php echo $filterQuery; ?>"><?php echo $i; ?></a></li>
                <?php endfor; ?>
                <?php if ($currentPage < $totalPages) : ?>
                    <li class="page-item"><a class="page-link" href="<?php echo BASE_URL; ?>admin/barang/<?php echo $currentPage + 1; ?><?php echo $filterQuery; ?>">Next</a></li>
                <?php else : ?>
