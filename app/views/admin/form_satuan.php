        ...
        <form action="<?php echo BASE_URL; ?>admin/processSatuan" method="POST">
            ...
            <div style="margin-bottom: 20px;">
                <h4 style="color: #152e4d; font-weight: 700; border-bottom: 2px solid #f1f5f9; padding-bottom: 8px; margin-bottom: 8px;">
                    <i class="ph ph-scales" style="color: #f8c21a; margin-right: 5px;"></i> Informasi Satuan
                </h4>
                <p style="color: #64748b; font-size: 0.9rem; margin: 0; line-height: 1.4;">
                    Satuan digunakan untuk menetapkan standar hitungan barang (Contoh: Pcs, Kg, Box, Liter).
                </p>
            </div>
            ...
            <div style="padding: 0 5px;">
                ...
                <div class="form-group" style="margin-bottom: 15px;">
                    <label for="nama_satuan" style="font-weight: 600; color: #334155; margin-bottom: 6px; display: block;">
                        Nama Satuan <span style="color: red;">*</span>
                    </label>
                    <input type="text" id="nama_satuan" name="nama_satuan" 
                           class="form-control"
                           value="<?php echo $isEditMode ? htmlspecialchars($sat['nama_satuan']) : ''; ?>" 
                           placeholder="Contoh: Pcs, Box, Pack, Kg" 
                           required
                    ...
                    <small style="color: #94a3b8; font-size: 0.8rem; margin-top: 4px; display: block;">
                        *Nama satuan harus singkat dan jelas.
                    </small>
                </div>
          ...
          placeholder="Keterangan tambahan untuk satuan ini..."><?php echo $isEditMode ? htmlspecialchars($sat['deskripsi'] ?? '') : ''; ?></textarea>
                </div>
            ...
            <div style="margin-top: 25px; border-top: 1px solid #e2e8f0; padding-top: 15px; display: flex; justify-content: flex-end; gap: 15px;">
                ...
                <a href="<?php echo BASE_URL; ?>admin/masterDataConfig#tab-satuan" class="btn btn-batal-custom" style="padding: 10px 20px;">
                    Batal
                </a>
                
                <button type="submit" class="btn btn-simpan-custom" style="padding: 10px 25px;">
                    <i class="ph ph-floppy-disk" style="font-size: 1.2rem;"></i> 
                    <?php echo $isEditMode ? 'Simpan Perubahan' : 'Simpan Satuan'; ?>
                </button>
