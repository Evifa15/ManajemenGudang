...
<main class="app-content">
    ...
    <div class="dashboard-widgets widget-group-peringatan">
        <a href="<?php echo BASE_URL; ?>pemilik/laporanStok?status=menipis" class="widget widget-peringatan <?php echo ($data['widget_peringatan']['stok_menipis'] > 0) ? 'active' : ''; ?>">
            <h4>Stok Menipis</h4>
            <span><?php echo $data['widget_peringatan']['stok_menipis']; ?></span>
            <p>Item perlu di-restock</p>
        </a>
        <a href="<?php echo BASE_URL; ?>pemilik/laporanPeminjaman?status=Jatuh+Tempo" class="widget widget-peringatan <?php echo ($data['widget_peringatan']['jatuh_tempo'] > 0) ? 'active' : ''; ?>">
            <h4>Peminjaman Jatuh Tempo</h4>
            <span><?php echo $data['widget_peringatan']['jatuh_tempo']; ?></span>
            <p>Aset belum kembali</p>
        </a>
        <a href="<?php echo BASE_URL; ?>pemilik/laporanTransaksi#tab-rusak" class="widget widget-peringatan <?php echo ($data['widget_peringatan']['barang_rusak'] > 0) ? 'active' : ''; ?>">
    ...
    <div class="dashboard-widgets widget-group-pengawasan">
        ...
        <div class="widget widget-log">
            ...
            <a href="<?php echo BASE_URL; ?>pemilik/auditTrail" style="margin-top: 10px; display: inline-block;">Lihat Audit Trail Lengkap...</a>
        </div>
    </div>
...
<script>
    ...
    const myChart = new Chart(ctx, {
        type: 'bar', // Tipe grafik (bisa 'line')
        data: {
            labels: labels,
            datasets: [
                {
